...
### Ch 13, C7: A fair coin is tossed 3 times
...
### Ch 14, A1: 
#### two fair dice are thrown. What is the chance that the sum is 5?
```{r}
# four possible ways to make 5 - 1:4, 2:3, 3:2, 4:1
# total combinations is 36
4/36
```

### Ch 14, A3: 
#### a pair of fair dice is thrown 1,000 times. What total should appear most often? What totals should appear least often?
```{r}
# 7 should appear most often
# 2 and 12 should appear least often
```
